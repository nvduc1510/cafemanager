...
import com.example.BackEnd.config.jwt.AuthEntryPoint;
import com.example.BackEnd.config.jwt.JWTokenProvider;
import com.example.BackEnd.config.jwt.JwtTokenFilter;
...
public class SecurityConfiguration {
    ...
    SecurityConfiguration(JWTokenProvider tokenProvider, UserDetailsService userDetailsService) {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests(authz -> authz
                ...
                .antMatchers(Constants.ENDPOINTS_WITH_ROLE_ADMIN).hasRole("ADMIN")
